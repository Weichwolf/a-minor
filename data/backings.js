...
{ id:'lamento', title:'Lamento-Bass', what:'i–VII–VI–V. Der Bass fällt stufenweise vom Grundton zur Quinte.',
  ...
  variations:[
    ...
    { title:'E Form A B A C', note:'A Lamento, B Doom-Vamp VI–VII, C Kadenz iv–V. 16 Takte, Strophe und Ausweg.', cfg:{type:'loop', root:'E', scale:'aeolian', parts:{A:['i','VII','VI','V:maj'], B:['VI','VII','i','i'], C:['iv','V:maj','i','i']}, form:'A B A C', time:'4/4', bars:16, drums:'half', tempo:60} },
  ]},
...
{ id:'doomvamp', title:'Doom-Vamp', what:'i–VI, oder i–VI–VII. Grundton und die Dur-Akkorde auf b6 und b7.',
  ...
  variations:[
    ...
    { title:'E Form A B A C', note:'A i–VI, B i–VI–VII, C III–VII–VI–V. Refrain-Gefühl in C.', cfg:{type:'loop', root:'E', scale:'aeolian', parts:{A:[{deg:0, bars:2}, {deg:5, bars:2}], B:['i','i','VI','VII'], C:['III','VII','VI','V:maj']}, form:'A B A C', time:'4/4', bars:16, drums:'half', tempo:58} },
  ]},
{ id:'dorisch', title:'Dorischer Vamp', what:'i–IV in Dorisch. Moll-Grundton, Dur-Subdominante.',
  ...
  variations:[
    ...
    { title:'A Form A B A C', note:'A i–IV, B VII–IV, C i–III–VII–IV. Anathema-Bogen.', cfg:{type:'loop', root:'A', scale:'dorian', parts:{A:[{deg:0, bars:2}, {deg:3, bars:2}], B:['VII','IV','VII','IV'], C:['i','III','VII','IV']}, form:'A B A C', time:'4/4', bars:16, drums:'straight', tempo:72} },
  ]},
...
{ id:'ritornell', title:'Ritornell in Dur', what:'Dur-Folgen mit klarer Kadenz: I–IV–V–I und die Pachelbel-Sequenz.',
  ...
  variations:[
    ...
    { title:'C Form A B A C', note:'A Kadenz, B Quintfall-Ausschnitt vi–ii–V–I, C IV–V–I–I. Ritornell-Logik.', cfg:{type:'loop', root:'C', scale:'major', parts:{A:['I','IV','V','I'], B:['vi','ii','V','I'], C:['IV','V','I','I']}, form:'A B A C', time:'4/4', bars:16, drums:'straight', tempo:90} },
  ]},
];
